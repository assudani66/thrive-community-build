...
const MobileNavBar = () => {
  ...
  return (
    <div className='bg-white w-full max-w-xs h-15 px-10 pt-2 pb-4 flex
      items-center
      justify-between text-gray-font fixed bottom-0 shadow-lg z-40
      rounded-t-[28px]
      md:hidden
      '>
        ...
        <div className='cursor-pointer' onClick={()=>console.log('Search')}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="#FE9063" stroke-opacity="0.4" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M20.9999 21L16.6499 16.65" stroke="#FE9063" stroke-opacity="0.4" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>

        <button className='mainbutton rounded-[1.5rem] relative bottom-4 h-16 w-16 text-[10] flex items-center' onClick={()=>router.push("/create")}>
        ...
        <div className='cursor-pointer' onClick={()=>router.push("/message")}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
