  ...
  return (
    <div className='p-0'>
      ...
      <div className='bg-indigo-500 h-fit flex justify-between rounded-lg text-white items-center'>
        ...
        <div className={`flex items-center h-full px-4 ${displayfeature.display === "FOLLOWING" ? 'selectedDisplayFeature' : ''} `}>
        ...
        <div className={`flex items-center h-full px-4 ${displayfeature.display === "FOLLOWERS" ? 'selectedDisplayFeature' : ''} `}>
